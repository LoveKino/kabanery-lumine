...
let page = (PageView, signalActionMap, {
    ...
    (pageEnv) => {
        ...
        let signalHandler = signalActionFlow(signalActionMap, pageEnv);
        let props = {
            onsignal: (signal) => {
                // binding the view data and context
                return signalHandler(signal, pageView.ctx.getData(), pageView.ctx);
            }
        };
